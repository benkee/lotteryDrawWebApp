...
<div>
    <form name="addUN" method="post" onsubmit="return validateForm()" action="AddUserNumbers">
        ...
        <input type="number" id="nu1" min="0" max="60"><br>
        <label for="nu2">No.2:</label>
        <input type="number" id="nu2" min="0" max="60"><br>
        <label for="nu3">No.3:</label>
        <input type="number" id="nu3" min="0" max="60"><br>
        <label for="nu4">No.4:</label>
        <input type="number" id="nu4" min="0" max="60"><br>
        <label for="nu5">No.5:</label>
        <input type="number" id="nu5" min="0" max="60"><br>
        <label for="nu6">No.6:</label>
        <input type="number" id="nu6" min="0" max="60"><br>
